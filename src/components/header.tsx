...
const Header = () => {
    ...
    return(
        <header className="sticky top-0 z-50 w-full border-blur bg-background/95 backdrop-blur py-2 supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto flex h-16 items-center justify-between px-4">
                <Link to={'/'}>
                    <img src={isDark ? "/logo2.png" : "/logo1.png"} alt="Weather Logo" className="h-24"/>
                </Link>
